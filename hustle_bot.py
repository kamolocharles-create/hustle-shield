...
def generate_invoice_pdf(invoice, ref, cuin):
    ...
    story = []
    story.append(Paragraph("Hustle Shield Technologies", title_style))
    ...
    story.append(Paragraph("Generated by Hustle Shield Technologies · Powered by Digitax & KRA eTIMS", footer_style))
    doc.build(story)
    return buf.getvalue()
...
STRINGS = {
    "en": {
        "welcome": (
            "👋 Welcome{name} to *Hustle Shield Technologies*!\n\n"
        ...
        "menu": (
            "🧾 *Hustle Shield Technologies – eTIMS Invoicing*\n\n"
            "Commands:\n"
            ...
            "Powered by Digitax & KRA eTIMS ✅\nHustle Shield Technologies"
        ),
        "subscribe_menu": (
            "💳 *Hustle Shield Technologies Plans*\n\n"
    ...
    "sw": {
        "welcome": (
            "👋 Karibu{name} *Hustle Shield Technologies*!\n\n"
        ...
        "menu": (
            "🧾 *Hustle Shield Technologies – Ankara za eTIMS*\n\n"
            "Amri:\n"
        ...
        "subscribe_menu": (
            "💳 *Mipango ya Hustle Shield Technologies*\n\n"
...
@app.get("/")
def root():
    return jsonify({"status":"ok","service":"hustle-shield-technologies"}), 200
